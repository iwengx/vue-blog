...
export default defineComponent({
   ...
   setup(props) {
      ...
      return { sun, moon, router, foldIconDom, unfoldIconClickEvent, changeGlobalEvent };
   },
});
</script>
